  ...
  return (
    <div className={styles.drawerBackdrop}>
      <div className={styles.drawerPanel}>
        <button type="button" className={styles.closeDrawerBtn} onClick={() => navigate('/app/sales/plots')} aria-label="Close" title="Close">
          ✕
        </button>
          ...
          <div className={styles.wrap}>
            ...
            {plot.status === 'Subdivided' && (
              <div className={styles.section}>
                ...
                <div className={styles.childList}>
                  {siblings.map((s) => (
                    <button key={s.id} type="button" className={styles.childRow} onClick={() => navigate(`/app/sales/plots/${s.id}`)}>
            ...
            {parent && (
              <p className={styles.helpText}>
                ...
                <button type="button" className={styles.linkBtn} onClick={() => navigate(`/app/sales/plots/${parent.id}`)}>
                ...
                <>
                  ...
                  <div className={styles.actionsRow}>
                    ...
                    <button
                      ...
                      onClick={() => del.mutateAsync(plot.id).then(() => navigate('/app/sales/plots'))}
                    >
