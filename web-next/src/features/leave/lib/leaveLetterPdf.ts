...
// Exact port of index.html's buildLeaveLetterText() (index.html:23711-
// 23736) -- v1's real leave letter is fully auto-generated, not free text
// typed by the requester: the regular leave flow has no reason field at
// all in v1, only Emergency Leave appends one extra line after this same
// generated body (see EmergencyLeaveForm in LeaveScreen.tsx, which does
// exactly that -- "\n\n(Emergency leave — <reason>)").
...
// Exact port of index.html's buildLeaveLetterPDF() (index.html:23737-
// 23798) -- same line-by-line parse of the generated letter text (title
// centered/underlined, "- " bullet lines indented, staff signs bottom-left
// under "Yours faithfully,", Management's signature stamped directly
// opposite it once approved -- side by side like a real signed contract,
// not a separate block further down the page).
