...
One item remains open on this punch list: **#4 (import transactionality)** — a real, architecturally larger fix (a wrapping RPC), next in line. #5 (realtime) closed, see §32.
