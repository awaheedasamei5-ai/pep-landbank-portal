...
export const sidebarItems: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "referrals", title: "Referrals", url: NOT_BUILT_YET, icon: Send },
      { id: "complaints", title: "Complaints", url: NOT_BUILT_YET, icon: AlertTriangle },
      { id: "company-leads", title: "Company Leads", url: NOT_BUILT_YET, icon: Building2 },
    ],
  },
  {
    id: 3,
    ...
    items: [
      ...
      { id: "quotation", title: "Quotation", url: NOT_BUILT_YET, icon: ReceiptText },
