...
// banner app from v1 and paste and merge into this version." Literal
// port of web-next's own BannerTrackingScreen.tsx -- useBanners.ts
// already existed in this shell (byte-identical to web-next's own,
// confirmed diff), only the screen itself was missing. The "← Back"
// button web-next's version had (to its own /app/office hub) is dropped
// -- this shell has no Office Desk hub page; every app here (Complaints,
// Enquiries, Referrals, ...) is a direct top-level sidebar link with no
// back button, and Banner Tracking is now one of them too.
//
// Dashboard + List only -- a real, honest first pass. Map & Routes
// (Leaflet-based) and Reports (filterable export view), plus the
// separate banner_status_log audit trail and photo/geolocation capture,
// are deliberately deferred: each is a substantial, separable piece of
// its own, same scoping discipline as this session's other gap fixes.
